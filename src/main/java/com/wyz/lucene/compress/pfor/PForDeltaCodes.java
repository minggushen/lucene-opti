...
public class PForDeltaCodes extends AbstractIntRangeCodes {
	...
	private static int[] fastDecodeFrame( int headerPos, int[] encodedValue, int decodeOffset, int[] decode, boolean useGapList ){
		...
		switch(numFrameBit){
			case 1  : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor1Bit ( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 2  : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor2Bit ( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 3  : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor3Bit ( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 4  : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor4Bit ( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 5  : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor5Bit ( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 6  : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor6Bit ( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 7  : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor7Bit ( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 8  : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor8Bit ( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 9  : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor9Bit ( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 10 : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor10Bit( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 11 : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor11Bit( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 12 : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor12Bit( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 13 : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor13Bit( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 14 : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor14Bit( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 15 : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor15Bit( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 16 : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor16Bit( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 17 : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor17Bit( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 18 : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor18Bit( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 19 : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor19Bit( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 20 : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor20Bit( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 21 : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor21Bit( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 22 : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor22Bit( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 23 : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor23Bit( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 24 : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor24Bit( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 25 : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor25Bit( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 26 : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor26Bit( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 27 : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor27Bit( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 28 : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor28Bit( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 29 : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor29Bit( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 30 : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor30Bit( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 31 : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor31Bit( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
			case 32 : IntOffsetForException = PForDeltaDecompress.fastDeCompressFor32Bit( encodeOffset, encodedValue, dataNum, decodeOffset, decode ); break;
